...
public class Visionneuse extends Parent {
	...
	/**
	 * This function is used to get the width of the AnchorPane associated with
	 * the visionneuse.
	 *
	 * @author TheHaricover
	 */
	...
	/**
	 * This function is used to get the height of the AnchorPane associated with
	 * the visionneuse.
	 *
	 * @author TheHaricover
	 */
	...
	/**
	 * This function is used to set the width of the AnchorPane associated with
	 * the visionneuse.
	 *
	 * @author TheHaricover
	 */
	...
	/**
	 * This function is used to set the height of the AnchorPane associated with
	 * the visionneuse.
	 *
	 * @author TheHaricover
	 */
	...
	/**
	 * This function is used to get the instance of the visionneuse. If there is
	 * no instance, it's created.
	 *
	 * @author TheHaricover
	 */
	...
	/**
	 * This function is used to call the display function with the GitObject
	...
	public static void display(GitObject gitObject) throws IOException,
		...
		if (gitObject.getType().equals(GitObjectType.BLOB)) {
			...
			visionneuse.getChildren().add(textArea);
		} else if (gitObject.getType().equals(GitObjectType.COMMIT)) {
