...
public class BinaryFile {
	/**
	 * Return the content of the file specified by the path argument as a byte
	 * array.
	 * 
	 * @author VieVie31
	 * 
	 * @param path
	 *            the path of the binary file to read
	 ...
	 * 
	 * @param data
	 *            an input byte array to decompress using zlib
	...
	/**
	 * Return a decompressed file content, using the zlib algorithm , as byte
	 * array.
	 * 
	 * @author VieVie31
	 * 
	 * @param path
	 *            of the binary file to decompress
